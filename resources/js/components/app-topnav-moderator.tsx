...
const baseItems: NavItem[] = [
  ...
  { label: 'Produkcja', href: '/dashboard/moderator/production' },
  { label: 'Szczegóły maszyn', href: '/dashboard/moderator/machines' },
  { label: 'Planowanie', href: '/dashboard/moderator/planning' },
  { label: 'Wydziały', href: '/dashboard/moderator/departments' },
];
...
export default function ModeratorTopNav() {
  ...
  return (
    <nav className="w-full bg-slate-900 text-white shadow-md border-b border-slate-800" role="navigation" aria-label="Menu moderatora">
      <div className="w-full flex flex-wrap items-center justify-between px-4 lg:px-8 py-2">
        <Link href="/dashboard" className="mr-4 block cursor-pointer py-1.5 text-base text-gray-200 font-semibold select-none">Panel Moderatora</Link>
